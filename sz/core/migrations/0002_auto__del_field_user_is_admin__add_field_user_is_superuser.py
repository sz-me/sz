...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'core_user', 'is_admin')

        # Adding field 'User.is_superuser'
        db.add_column(u'core_user', 'is_superuser',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'core_user', 'is_admin',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'User.is_superuser'
        db.delete_column(u'core_user', 'is_superuser')
