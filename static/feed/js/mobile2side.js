...
//         $("#tagsPlace").height(elHeight);
        ...
        $("#dollyPlace").height(304);
//         $("#gender").css({marginTop:'30px'});
        var dollyWidth=113;
        $(".dollyFoot").css({marginTop:'7px'});
        $(".dollyLegs,.dollyBody").css({marginTop:'7px'});
        $("#tagsPlace").height(305);
        
    }
    
    tagsRow = Math.floor((winWidth-dollyWidth)/76);
    var tagsPlaceWidth = tagsRow*76;
    var margin = (winWidth-dollyWidth-tagsPlaceWidth)/3;
    var tagsMarginLeft = dollyWidth+margin*2;
    $("#gender").css({marginLeft:margin+'px'});
    ...
    $("#tagsPlace").width(tagsPlaceWidth).css({marginLeft:tagsMarginLeft+'px'});
