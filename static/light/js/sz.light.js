...
sz.light.ControlView = function(){
    ...
    this.getHtmlSearchMenu = function(model){
        return '<span id="' + this.searchMenuContainerId + '">' +
            '<label class = "radio" for = "' + this.messageRadioId + '">' +
            '<input type = "radio"' +
            'name = "sz_lite_what"' +
            'id = "' + this.messageRadioId + '"' +
            'value = "message"' +
            'checked = "checked"' +
            'class = "message-radio" /> things</label> or ' +
            '<label class="radio" for = "' + this.placeRadioId + '" >' +
            '<input type = "radio"' +
            'name = "sz_lite_what"' +
            'id = "' + this.placeRadioId + '"' +
            'value = "place"' +
            'class = "place-radio" /> places</label> ' +
            '<label class="checkbox" for="' + this.nearbyCheckboxId + '">' +
            '<input id="' + this.nearbyCheckboxId + '" type="checkbox" title="nearby"/> nearby</label>' +
            '</span>';
    };
    this.getHtmlPostingMenu = function(model){
        return '<span id="' + this.postingMenuContainerId + '" hidden>' +
            '<button class="submit-button btn-small btn-primary" id="' + this.submitButtonId + '">Post</button>' +
            '<button class="cancel-button btn-small" id="' + this.cancelButtonId + '">Back</button>' +
            '</span>';
    };
